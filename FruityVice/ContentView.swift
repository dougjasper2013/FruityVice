    ...
    func savePDFReport() {
        ...
        let data = renderer.pdfData { context in
            for fruit in fruits {
                ...
                let addressString = info.address ?? "Unknown Address"
                ...
                """
                text.draw(in: CGRect(x: 20, y: 20, width: pageWidth - 40, height: 140), withAttributes: textAttributes)

                let maxWidth = pageWidth - 40
                let maxHeight = pageHeight - 200
